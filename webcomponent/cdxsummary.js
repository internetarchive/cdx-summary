...
The <code>Revisit</code> records do not represents an independent media type, instead, they reflect an unchanged state of resources from some of their prior observations (i.e., the same media type, content digest, and HTTP status code).
